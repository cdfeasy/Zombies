...
import zombies.entity.support.DeckInfo;
         ...
         u.setGold(this.getGold());
            if(withInfo){
                ...
                for(Deck d:this.getDecks()){
                     u.getDecksIds().add(new DeckInfo(d.getId(),d.getDeckCards()));
                }
                ...
                u.setActiveDeckIds(new DeckInfo(this.getActiveDeck().getId(),this.getActiveDeck().getDeckCards()));
            }
        }
        if(full){
            u.setXp(this.getXp());
            ...
            if(!this.getDecks().isEmpty()) {
                ...
                for(Deck d:this.getDecks()){
                    ...
                    dCopy.setDeckCards(new ArrayList<Card>());
                    for(Card c:d.getDeckCards()){
                       dCopy.getDeckCards().add(cardMap.get(c.getId()));
                    }
            ...
            dCopy.setDeckCards(new ArrayList<Card>());
            for(Card c:this.getActiveDeck().getDeckCards()){
                dCopy.getDeckCards().add(cardMap.get(c.getId()));
            }
