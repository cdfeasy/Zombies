...
//        System.out.println(mapper.writeValueAsString(act))  ;
        Date d2 = new Date();
        for (int i = 0; i < 10000; i++) {
            mapper.readValue("{\"zombies.dto.reply\":5,\"connectionReply\":{\"token\":\"ul\",\"version\":\"1\"}}", UserReply.class);
        }
        Date d3 = new Date();
